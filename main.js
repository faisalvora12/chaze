...
request.onreadystatechange = function () {
    if (request.readyState === 4 && request.status === 200) {
      ...
      for(i=1;i<str.length;i++)
      {
       ...
       $("#panels").append("<div id='dummy"+i+"' class='col-sm panel panel-default' style='background-color: white'><label id='"+i+"' class='panel-body classWithPad'><canvas id='myChart"+i+"' width='150' height='100'></canvas> Training "+i+"\nTotal# laes:85\nTotal time: 500 secs\nAvg power:30\nAvg speed:50"/*+"//"+str2[1]+"//"+str2[2]+" //   "+str2[3]+"   //    "+str2[4]+"   //    "+str2[5]+"   //    "+str2[6]*/+"</label></div>"); 
